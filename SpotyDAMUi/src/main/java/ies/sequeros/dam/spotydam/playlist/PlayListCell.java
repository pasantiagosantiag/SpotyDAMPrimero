...
public class PlayListCell extends GridCell<PlayList> {

    private Label label;
    private VBox vbox;
    private ImageView imageView;
    private Label titleLabel;
    private Consumer<PlayList> onView;
    private Consumer<PlayList> ondelete;
    private Consumer<PlayList> onedit;
    ...
    public void setOnView(Consumer<PlayList> onView) {
        this.onView = onView;
    ...
    public void setOnEdit(Consumer<PlayList> onEdit) {
        this.onedit = onEdit;
    }
    ...
    protected void updateItem(PlayList item, boolean empty) {
        ...
        if (empty || item == null) {
            ...
            if (Files.exists(Path.of(item.getImage())))
                this.imageView.setImage(new Image(Path.of(item.getImage()).toUri().toString(), 1120, 120, true, true));
